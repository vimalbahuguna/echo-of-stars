...
const YogaNidraPractice = () => {
  ...
  const [history, setHistory] = useState<YogaNidraSession[]>([]);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-card/50 border-primary/20 shadow-stellar">
              <CardHeader>
                ...
                <CardDescription>
                  Start a new yoga nidra practice session
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select value={practiceType} onValueChange={setPracticeType} disabled={timerRunning}>
                    <SelectTrigger>
                      <SelectValue placeholder="Select yoga nidra type" />
                    </SelectTrigger>
                    <SelectContent>
                      {yogaNidraTypes.map((type) => (
            ...
            <Card className="bg-card/50 border-primary/20 shadow-stellar">
              <CardHeader>
                ...
                <CardDescription>
                  Your recent yoga nidra sessions
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loading ? (
...
export default YogaNidraPractice;