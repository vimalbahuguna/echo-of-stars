          ...
          <Card className="w-full max-w-6xl mx-auto bg-card/50 border-primary/20 shadow-stellar">
            <CardHeader className="text-center pb-6">
              ...
              <CardDescription className="text-muted-foreground text-lg">
                Personalized gemstones, mantras, and spiritual remedies based on your planetary positions
              </CardDescription>
            </CardHeader>
            <CardContent>
              <RemedialMeasures planets={mockPlanets} />
            </CardContent>
          </Card>
        </div>
      </div>
...
export default RemedialMeasuresPage;