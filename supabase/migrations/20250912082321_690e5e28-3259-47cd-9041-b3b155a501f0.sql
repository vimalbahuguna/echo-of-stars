-- Multi-tenant Enterprise System with Geographic Hierarchy and RBAC - Fixed
...
INSERT INTO public.tenants (name, slug, status, subscription_tier)
VALUES ('Default Tenant', 'default', 'active', 'basic');
-- Insert default role permissions with proper enum casting
INSERT INTO public.role_permissions (tenant_id, role, resource, actions) 
SELECT 
    t.id,
    perm_data.role::public.user_role,
    perm_data.resource,
    perm_data.actions
